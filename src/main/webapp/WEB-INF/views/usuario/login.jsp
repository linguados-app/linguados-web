    ...
    <div class="login-container">
        <div class="login-card">
            ...
            <p style="margin-top: 25px; color: #86868b;">
                Não tem uma conta? <a href="cadastro" style="color: var(--duo-green); text-decoration: none; font-weight: bold;">Cadastre-se</a>
            </p>
        </div>
    </div>
       ...
       <head>
           ...
           <style>
               .login-container {
                   ...
                   align-items: center;
                   height: 100vh;
                   background-color: white; /* Estilo Apple: Fundo limpo */
               }
               ...
               /* Input estilo Apple: Bordas finas e cinzas */
