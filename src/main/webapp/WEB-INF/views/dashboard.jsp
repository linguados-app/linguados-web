 ...
 <body class="dashboard-body">
     ...
     <main class="main-content">
         ...
         <c:if test="${not empty param.mensagemConcluido}">
             <div style="background-color: #e6fcf5; border: 1px solid #c3fae8; color: #0ca678; padding: 16px 20px; border-radius: 16px; margin-bottom: 24px; font-weight: bold; font-family: 'Nunito', sans-serif; display: flex; align-items: center; gap: 12px; box-shadow: 0 4px 12px rgba(12, 166, 120, 0.06);">
