                ...
                <div class="team-grid orientadores-grid">
                    <div class="member-card advisor-card">
                        <div class="member-photo-wrapper">
                            <img src="${pageContext.request.contextPath}/assets/img/sara.png" alt="Moniky" class="member-photo" onerror="this.src='https://api.dicebear.com/7.x/bottts/svg?seed=Moniky';">
                        </div>
